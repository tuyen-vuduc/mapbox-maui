...
public class DslExpression : List<object>
{
    ...
    public static DslExpression stringLiteral(params object[] arguments) => new(DslOperator.stringLiteral, arguments);
    ...
    public static DslExpression toString(params object[] arguments) => new(DslOperator.toString, arguments);
