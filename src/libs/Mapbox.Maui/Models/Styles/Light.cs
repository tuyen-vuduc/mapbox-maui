...
public class Light : BaseKVContainer
{
    ...
    public Anchor Anchor
    {
        ...
        set => SetProperty<Anchor>(LightKey.anchor, value);
    }
    ...
    public Color Color
    {
        ...
        set => SetProperty<Color>(LightKey.color, value);
    }
    ...
    public StyleTransition ColorTransition
    {
        ...
        set => SetProperty<StyleTransition>(LightKey.colorTransition, value);
    }
    ...
    public double Intensity
    {
        ...
        set => SetProperty<double>(LightKey.intensity, value);
    }
    ...
    public StyleTransition IntensityTransition
    {
        ...
        set => SetProperty<StyleTransition>(LightKey.intensityTransition, value);
    }
    ...
    public StyleTransition PositionTransition
    {
        ...
        set => SetProperty<StyleTransition>(LightKey.positionTransition, value);
    }
